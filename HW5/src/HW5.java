...
public class HW5{
	...
	public static void saveAsFile(String fn)throws Exception{
		//creates a new file on desktop (put desired file location in " ")
		PrintStream out = new PrintStream("C:\\Users\\tobad\\Desktop\\"+fn);
		//prints method distance in new file
		out.println(distance(40,3));
		out.close();
	}
	...
	public static void main(String[]args)throws Exception{
		...
		while(sc.hasNext()){
			...
			distance = Integer.valueOf(speed)*Integer.valueOf(time);
			System.out.println(vc+"'s speed = "+distance);
		}
